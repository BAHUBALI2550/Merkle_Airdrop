...
contract MerkleAirdrop is EIP712 {
   ...
   function claim(address account, uint256 amount, bytes32[] calldata merkleProof, uint8 v, bytes32 r, bytes32 s) external {
    // we are using signature, so that if anyone else want to claim token into my account but they pay the gas fee, they can do that
    // they can call the claim function for me, i give my signature and wholla!! i get the token into my account without paying the gas fee
